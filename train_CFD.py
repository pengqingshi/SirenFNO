...
@dataclass
class CFG:
    data_file: str = "Data/1D_CFD_Rand_Eta0.01_Zeta0.01_periodic_Train.hdf5"
    dataset_url: str = "https://darus.uni-stuttgart.de/api/access/datafile/164672"

    reduce_x: int = 1
    reduce_t: int = 1  # 201 -> 201 (no temporal reduction by default)
...
def train():
    ...
    train_cpu = load_subset_to_ram(reduced_path, train_idx)
    test_cpu = load_subset_to_ram(reduced_path, test_idx)
